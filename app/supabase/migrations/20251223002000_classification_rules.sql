...
-- NOTE: Audit logging for classification rules is handled at the application
-- level via the config_audit_logs table (Story 22-10). Database-level triggers
-- are not used here to avoid schema dependencies and allow richer audit metadata.
